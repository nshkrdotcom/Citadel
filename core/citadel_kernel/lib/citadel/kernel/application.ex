defmodule Citadel.Kernel.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      {Task.Supervisor, name: Citadel.Kernel.BoundaryLeaseBootstrapSupervisor, max_children: 32},
      {DynamicSupervisor,
       strategy: :one_for_one, name: Citadel.Kernel.SignalIngress.PartitionSupervisor},
      ...
      {Citadel.Kernel.KernelSnapshot.ReadSurfaceRegistry,
       name: Citadel.Kernel.KernelSnapshot.ReadSurfaceRegistry},
      {Citadel.Kernel.KernelSnapshot,
       name: Citadel.Kernel.KernelSnapshot,
       read_surface_registry: Citadel.Kernel.KernelSnapshot.ReadSurfaceRegistry},
      ...
      {Citadel.Kernel.SessionDirectory.StoreOwner,
       name: Citadel.Kernel.SessionDirectory.StoreOwner},
      {Citadel.Kernel.SessionDirectory,
       name: Citadel.Kernel.SessionDirectory,
       kernel_snapshot: Citadel.Kernel.KernelSnapshot,
       store_owner: Citadel.Kernel.SessionDirectory.StoreOwner},
      {Citadel.Kernel.BoundaryLeaseTracker,
       name: Citadel.Kernel.BoundaryLeaseTracker,
       kernel_snapshot: Citadel.Kernel.KernelSnapshot,
       bootstrap_task_supervisor: Citadel.Kernel.BoundaryLeaseBootstrapSupervisor},
      {Citadel.Kernel.SignalIngress,
       ...
       partition_worker_supervisor: Citadel.Kernel.SignalIngress.PartitionSupervisor,
       auto_rebuild?: false},
