defmodule Citadel.ProjectionBridge.ReviewProjectionAdapter do
  ...
  @spec normalize!(ReviewProjection.t() | RuntimeObservation.t()) :: ReviewProjection.t()
  ...
  defp selected_attempt(%RuntimeObservation{
         subject_ref: %SubjectRef{kind: :attempt} = subject_ref
       }),
       do: subject_ref
