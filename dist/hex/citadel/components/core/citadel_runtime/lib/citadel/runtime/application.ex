defmodule Citadel.Runtime.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      {Citadel.Runtime.PolicyCache,
       name: Citadel.Runtime.PolicyCache, kernel_snapshot: Citadel.Runtime.KernelSnapshot},
      {Citadel.Runtime.TopologyCatalog,
       name: Citadel.Runtime.TopologyCatalog, kernel_snapshot: Citadel.Runtime.KernelSnapshot},
      {Citadel.Runtime.KernelSnapshot, name: Citadel.Runtime.KernelSnapshot},
      {Citadel.Runtime.ScopeCatalog,
       name: Citadel.Runtime.ScopeCatalog, kernel_snapshot: Citadel.Runtime.KernelSnapshot},
      {Citadel.Runtime.ServiceCatalog,
       name: Citadel.Runtime.ServiceCatalog, kernel_snapshot: Citadel.Runtime.KernelSnapshot},
      {Citadel.Runtime.SessionDirectory,
       name: Citadel.Runtime.SessionDirectory, kernel_snapshot: Citadel.Runtime.KernelSnapshot},
      {Citadel.Runtime.BoundaryLeaseTracker,
       name: Citadel.Runtime.BoundaryLeaseTracker, kernel_snapshot: Citadel.Runtime.KernelSnapshot},
