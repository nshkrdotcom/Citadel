...
- [x] Add red tests that prove `Citadel.Runtime.start_session/1` wires the default trace publisher.
...
- [x] Inject `Citadel.Runtime.TracePublisher` by default from `Citadel.Runtime.start_session/1`.
