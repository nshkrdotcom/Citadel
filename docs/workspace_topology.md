...
`Weld` is pinned at the workspace root as a tooling-only placeholder, but publication remains late and derivative. Wave 1 does not define a welded artifact, and nothing in this repo should collapse package ownership to serve publication convenience.
